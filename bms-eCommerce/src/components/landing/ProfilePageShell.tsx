...
export const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { icon: Crown, label: "BMS Member", key: "member", path: "/settings" },
  { icon: Bell, label: "การแจ้งเตือน", key: "notifications", path: "/settings" },
  { icon: Tag, label: "โค้ดส่วนลด", key: "coupons", path: "/settings" },
  { icon: Heart, label: "สิ่งที่ถูกใจ", key: "wishlist", path: "/settings" },
