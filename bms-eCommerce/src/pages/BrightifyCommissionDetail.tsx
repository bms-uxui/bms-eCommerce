...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-1.5 text-[13px] text-[var(--color-neutral-500)]">
      ...
      <span>/</span>
      <Link to="/affiliate/commission/brightify" className="hover:text-[var(--color-primary)]">
        คอมมิชชัน BRIGHTIFY
      </Link>
      <span>/</span>
      <span className="text-[var(--color-neutral-900)]">รายละเอียด คอมมิชชัน BRIGHTIFY</span>
    </nav>
  );
}
...
export default function BrightifyCommissionDetail() {
  const { id } = useParams();
          ...
          <section className="bg-white rounded-2xl border border-[var(--color-neutral-300)] p-4 sm:p-5 flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
              <div className="flex flex-col gap-2 min-w-0">
                <h1 className="text-[16px] font-semibold text-[var(--color-neutral-900)]">รายละเอียด คอมมิชชัน BRIGHTIFY</h1>
                <div className="flex flex-col gap-1 text-[14px]">
                  <p className="text-[var(--color-neutral-600)]">
                    ชื่อสินค้าคอมมิชชัน : <span className="text-[var(--color-neutral-900)]">กระโปรงพลีทสั้นลายดอกไม้สีฟ้าสดใส</span>
                  </p>
                  <p className="text-[var(--color-neutral-600)]">
                    อัตราคอมมิชชัน : <span className="text-[var(--color-neutral-900)]">สูงสุด 3.0%</span>
                  </p>
                  <p className="text-[var(--color-neutral-600)]">
                    ระยะเวลาคอมมิชชัน : <span className="text-[var(--color-neutral-900)]">20/04/2026 - 00:00 / 20/08/2026 - 11:59</span>
                  </p>
                </div>
              </div>
              <button
